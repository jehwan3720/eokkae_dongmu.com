...
const categories = [
  {
    ...
    items: [
      {
        q: "강사 수업료가 정말 0원인가요? 어떻게 이것이 가능한가요?",
        a: "네, 강사 파견·수업 진행·교구 설명 등 모든 강사 서비스에 대한 비용은 발생하지 않습니다.\n\n이는 할인이나 이벤트가 아닙니다. 강사 운영 체계의 효율화와 반복 수업을 통한 운영비 절감을 교육비에 그대로 반영한 결과입니다. 발생하는 비용은 풍뎅이 키트(1개 10,000원)뿐입니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "없습니다. 강사가 모든 교구·표본·사육 재료를 지참하여 방문합니다.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "아닙니다. 어깨동무 키트는 '무관리 성장 시스템'으로 설계되었습니다. 유충병 한 통 안에서 성충까지 성장하는 데 필요한 모든 것이 포함되어 추가 먹이 급여, 톱밥 교체 등 어떤 보충 작업도 필요하지 않습니다. 선생님이 하실 일은 아이들의 관찰 일지 작성을 독려하는 것뿐입니다.",
      },
      {
        q: "교실에 두면 냄새가 나거나 위생 문제가 있지 않나요?",
        a: "친환경 톱밥과 밀폐 구조의 유충병을 사용하여 냄새·오염이 최소화된 설계입니다. 수업 후 교실 정리까지 강사가 담당합니다.",
      },
      {
